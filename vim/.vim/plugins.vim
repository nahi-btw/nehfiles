...
call s:ensure('tpope/vim-vinegar')
...
call s:ensure ('sergei-grechanik/vim-terminal-images')
call s:ensure ('jkramer/vim-checkbox')
call s:ensure('iamcco/markdown-preview.nvim')
call s:ensure('plasticboy/vim-markdown')
